...
// دالة مساعدة لعرض عنوان الشحن
const formatShippingAddress = (address: any): string => {
  if (typeof address === 'string') {
    return address;
  }
  if (address && typeof address === 'object') {
    return `${address.street || ''}, ${address.city || ''}`.replace(', ,', ',').trim();
  }
  return 'غير محدد';
};
...
export default function OrderDetails() {
  ...
  // دالة للاتصال بالصيدلية
  const handleCall = () => {
    const phoneNumber = '01124472899'; // الرقم المطلوب
          ...
          <View style={styles.deliveryInfo}>
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>
                  {formatShippingAddress(order.shippingAddress) || 'غير محدد'}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>011 244 7289</Text>
              </View>
            </View>
