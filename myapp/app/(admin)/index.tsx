  ...
  const loadDashboardData = async () => {
    try {
      ...
      if (statsResponse.ok) {
        ...
        // استخدام بيانات افتراضية بدلاً من Alert
        setStats({
          totalUsers: 0,
          totalProducts: 0,
          totalOrders: 0,
      ...
      if (ordersResponse.ok) {
        ...
        const recentOrdersData = ordersData.orders?.slice(0, 5) || [];
      ...
      if (usersResponse.ok) {
        ...
        const recentUsersData = usersData.users?.slice(0, 5) || [];
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <Text style={styles.homeButtonText}>العودة للتطبيق</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  logoutButton: {
    padding: 8,
    borderRadius: 20,
    backgroundColor: 'hsla(0, 92%, 47%, 0.20)',
  },
  container: {
    flex: 1,
    padding: 25,
